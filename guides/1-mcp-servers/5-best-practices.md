...
- [Thinking Modes](../5-thinking/1-overview.md) - Control reasoning depth and quality
- [Context Management](../6-context/1-overview.md) - Advanced context control strategies

**Explore Advanced Topics:**
- [Token Optimization](../8-optimization/1-cost-optimization.md) - Achieve 70%+ cost savings
- [Keywords & Triggers](../7-keywords/) - Power user features and automation
