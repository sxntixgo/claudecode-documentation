...
**Creating Skills**:
1. Follow [Skill Creation Guide](../../03-skills/2-creating-skills.md)
2. Test thoroughly
3. Document usage
...
**Starter Templates**:
- See [Examples Section](../../12-examples/1-overview.md)
- React + TypeScript
- Node.js API
- Django
- FastAPI
...
1. **Check Documentation**:
   - [Troubleshooting Guide](../../13-reference/2-troubleshooting.md)
...
- [Skill Creation](../../03-skills/2-creating-skills.md)
