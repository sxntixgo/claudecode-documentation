...
**Also Explore**:
- [Model Selection Deep Dive](../4-models/1-overview.md) - Complete guide to Haiku, Sonnet, and Opus
- [Token Optimization Strategies](../8-optimization/1-cost-optimization.md) - Advanced techniques for 70%+ savings
- [Context Management](../6-context/1-overview.md) - Control what agents see and remember
...
### Related Topics
- [Thinking Modes](../5-thinking/) - Control reasoning depth for better cost/quality trade-offs
- [Skills Model Assignment](../3-skills/4-model-assignment.md) - Similar techniques for skills
