...
**Next Guide**: [What Are Skills?](../3-skills/1-overview.md) (20 min)
Learn about skills - reusable instruction sets that leverage agents for specific workflows.

**Also Explore**:
- [Model Selection](../4-models/1-overview.md) - Deep dive into Haiku, Sonnet, and Opus
...
### Related Topics
- [Creating Custom Skills](../3-skills/3-creating-skills.md) - Build on agents with reusable skills
- [Slash Commands](../7-keywords/3-slash-commands.md) - Trigger agents with custom commands
