...
**Related Topics**:
- **[Slash Commands](../7-keywords/2-slash-commands.md)** → Manual workflow triggers
- **[Skills](../3-skills/1-overview.md)** → Custom instructions (combine with hooks)
- **[Token Optimization](../8-optimization/2-advanced-techniques.md)** → Efficient automation

**Examples**:
- **[Testing Workflow](../9-examples/workflows/7-testing.md)** → TDD with automated hooks
- **[Code Review Workflow](../9-examples/workflows/3-code-review.md)** → Pre-commit quality checks

**Complete Reference**:
- **[Plugin Ecosystem Guide](../13-plugins/1-plugin-ecosystem.md)** → All plugin types in detail
...
- [Automation Patterns](../7-keywords/3-automation-patterns.md) - Advanced automation techniques
- [Best Practices Catalog](../12-community/3-best-practices-catalog.md) - Community hook examples
