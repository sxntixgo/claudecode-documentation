...
| **"security"** / **"safe"** / **"private"** | [Security Guide](../15-security/1-security-compliance.md) |
...
**Full guide**: See [Creating Custom Agents](../03-agents/4-custom-agents.md)
...
**Full guide**: See [Creating Custom Skills](../04-skills/3-creating-skills.md)
...
**Full guide**: See [Model Selection Guide](../06-models/5-selection-guide.md)
...
**Full guide**: See [Agent Model Assignment](../03-agents/3-model-assignment.md)
...
**Full guide**: See [CLAUDE.md Files](../09-context/2-claude-md.md)
...
**Full guide**: See [Cost Optimization](../12-optimization/1-cost-optimization.md)
...
**Full guide**: See [Optimization Strategies](../12-optimization/2-advanced-techniques.md)
...
**Full guide with calculations**: See [Cost Optimization](../12-optimization/1-cost-optimization.md)
...
**Full guide**: See [Creating Slash Commands](../10-keywords/2-slash-commands.md)
...
**Full guide**: See [Automation Patterns](../10-keywords/3-automation-patterns.md)
