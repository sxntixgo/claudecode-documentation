...
**Learn More**:
- [Full Model Comparison](../06-models/5-selection-guide.md) - Detailed capabilities
- [Token Optimization](../12-optimization/1-cost-optimization.md) - Cost strategies
...
**Questions? See [FAQ](../14-reference/3-faq.md#model-selection)**
