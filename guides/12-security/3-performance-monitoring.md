...
**Prerequisites**: [Cost Optimization](../../8-token-optimization/1-cost-optimization.md), [Model Selection](../../04-models/5-selection-guide.md)
...
- [Model Selection](../../04-models/5-selection-guide.md)
- [Optimization Checklist](../../12-quick-reference/2-optimization-checklist.md)
- [Bug Fixing Workflow](../../10-examples/workflows/2-bug-fixing.md)
