...
**Related Topics**:
- **[Slash Commands](../07-keywords/2-slash-commands.md)** → Manual workflow triggers
- **[Skills](../03-skills/1-overview.md)** → Custom instructions (combine with hooks)
- **[Token Optimization](../09-optimization/2-advanced-techniques.md)** → Efficient automation

**Examples**:
- **[Testing Workflow](../10-examples/workflows/7-testing.md)** → TDD with automated hooks
- **[Code Review Workflow](../10-examples/workflows/3-code-review.md)** → Pre-commit quality checks

**Complete Reference**:
- **[Plugin Ecosystem Guide](../00-plugins-overview/1-overview.md)** → All plugin types in detail
...
- [Automation Patterns](../07-keywords/3-automation-patterns.md) - Advanced automation techniques
- [Best Practices Catalog](../13-community/3-best-practices-catalog.md) - Community hook examples
