...
**Prerequisites**: [Agents Overview](../../1-mcp-servers/1-overview.md), [Model Selection](../../4-models/5-selection-guide.md)
...
- [Agent Overview](../../2-agents/1-overview.md) - Understanding agents
- [Model Selection Guide](../../4-models/5-selection-guide.md) - Choosing models

### Related Topics

- [Explore Agent](../../2-agents/2-built-in-agents.md#explore-agent) - Read-only search
...
- [Test-Driven Development](../../9-examples/workflows/7-testing.md#tdd-workflow) - TDD with Claude
...
**Questions?** See the [FAQ](../../10-reference/3-faq.md) or [Troubleshooting Guide](../../10-reference/2-troubleshooting.md)
