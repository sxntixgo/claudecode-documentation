...
**Prerequisites**: [Agents Overview](../../2-agents/1-overview.md), [Plan Agent](../../2-agents/2-built-in-agents.md#plan-agent), [Model Selection](../../4-models/5-selection-guide.md)
...
- [Plan Agent](../../2-agents/2-built-in-agents.md#plan-agent) - Planning refactorings
- [Testing Guide](../../11-security/2-testing-quality.md) - TDD strategies

### Related Topics

- [Model Selection](../../4-models/5-selection-guide.md) - When to use Opus
