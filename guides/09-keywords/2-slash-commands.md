...
**Prerequisites**: [Keywords Overview](1-overview.md), [Creating Skills](../03-skills/3-creating-skills.md)
...
- [Token Optimization](../11-optimization/1-cost-optimization.md) - Optimize command costs
...
### Related Topics
- [Creating Skills](../03-skills/3-creating-skills.md) - Commands often invoke skills
- [Custom Agents](../02-agents/4-custom-agents.md) - Commands can use custom agents
