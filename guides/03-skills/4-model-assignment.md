...
**Prerequisites**: [What Are Skills?](1-overview.md), [Creating Custom Skills](3-creating-skills.md), [Model Assignment for Agents](../02-agents/3-model-assignment.md)
...
### Related Topics
- [Agent Model Assignment](../02-agents/3-model-assignment.md) - Similar strategies for agents
