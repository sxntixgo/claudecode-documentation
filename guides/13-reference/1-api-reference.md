...
- [Creating Custom Agents](../02-agents/4-custom-agents.md) - Using AGENT.md schema
- [Creating Custom Skills](../03-skills/3-creating-skills.md) - Using SKILL.md schema
- [Creating Slash Commands](../09-keywords/2-slash-commands.md) - Using command schema
- [CLAUDE.md Files](../08-context/2-claude-md.md) - Project context structure
- [Hooks Configuration](../09-keywords/3-automation-patterns.md) - Hook examples
...
- Want examples? Browse [Project Templates](../12-examples/projects/)
