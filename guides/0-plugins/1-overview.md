...
|------------|---------|---------|-----------|-----------|
| **MCP Servers** | Connect external tools | GitHub, databases, APIs | 🟡 Medium | [Section 1](../1-mcp-servers/1-overview.md) |
| **Skills** | Custom workflows | TDD, docs, reviews | 🟢 Easy | [Section 3](../3-skills/1-overview.md) |
| **Hooks** | Automation triggers | Auto-test, auto-format | 🔴 Advanced | [Section 7.5](../7-hooks/1-overview.md) |
| **Slash Commands** | Quick shortcuts | `/review-pr`, `/test` | 🟢 Easy | [Section 7](../7-keywords/2-slash-commands.md) |
...
**Learn More**: [MCP Servers Deep Dive →](../1-mcp-servers/1-overview.md)
...
**Learn More**: [Skills Deep Dive →](../3-skills/1-overview.md)
...
**Learn More**: [Hooks Deep Dive →](../7-hooks/1-overview.md)
...
**Learn More**: [Slash Commands Guide →](../7-keywords/2-slash-commands.md)
...
1. **[MCP Servers](../1-mcp-servers/1-overview.md)** (30 min) - Foundation: Add GitHub integration
2. **[Skills](../3-skills/1-overview.md)** (20 min) - Install your first skill
3. **[Slash Commands](../7-keywords/2-slash-commands.md)** (15 min) - Create a `/test` command
4. **[Hooks](../7-hooks/1-overview.md)** (25 min) - Advanced: Add auto-formatting

### For Experienced Users
Jump to what you need:
- **Extending capabilities**: [MCP Servers →](../1-mcp-servers/1-overview.md)
- **Custom workflows**: [Skills →](../3-skills/1-overview.md)
- **Automation**: [Hooks →](../7-hooks/1-overview.md)
- **Quick commands**: [Slash Commands →](../7-keywords/2-slash-commands.md)

### Want It All?
See the **[Complete Plugin Ecosystem Guide](../13-plugins/1-plugin-ecosystem.md)** (45 min) for comprehensive coverage with code examples, exercises, and deep dives.
...
1. **[MCP Servers](../1-mcp-servers/1-overview.md)** → Connect external tools (foundation)
2. **[Agents](../2-agents/1-overview.md)** → Specialized AI assistants
3. **[Skills](../3-skills/1-overview.md)** → Custom workflows (builds on agents)
4. **[Models](../4-models/1-overview.md)** → Choose right model
5. **[Thinking Modes](../5-thinking/1-overview.md)** → Control reasoning
6. **[Context Management](../6-context/1-overview.md)** → Manage memory
7. **[Keywords & Triggers](../7-keywords/1-overview.md)** → Slash commands
8. **[Hooks](../7-hooks/1-overview.md)** → Automation (advanced)
9. **[Token Optimization](../8-optimization/1-cost-optimization.md)** → Save costs

**Or jump directly to**:
- **[Complete Plugin Guide](../13-plugins/1-plugin-ecosystem.md)** → All details in one place
- **[Examples](../9-examples/1-overview.md)** → See plugins in action
