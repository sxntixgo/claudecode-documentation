...
**Related Topics:**
- [Agent Model Assignment](../03-agents/3-model-assignment.md) - Optimize agent costs
- [Skill Model Assignment](../04-skills/4-model-assignment.md) - Optimize skill costs
