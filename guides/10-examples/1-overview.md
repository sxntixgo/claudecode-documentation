...
cp -r guides/10-examples/projects/react-typescript/.claude/ .
...
```bash
# Copy specific files
cp guides/10-examples/projects/react-typescript/.claude/config.json .claude/
cp guides/10-examples/workflows/feature-development.md .claude/workflows/
```
...
- **Build an API** → [Node.js API](projects/2-nodejs-api.md)
- **Set up cost optimization** → [Team Patterns](teams/1-solo-developer.md)
- **Automate workflows** → [Workflow Templates](workflows/1-feature-development.md)
