...
**Prerequisites**: [Agents Overview](../../02-agents/1-overview.md), [Plan Agent](../../02-agents/2-built-in-agents.md#plan-agent), [Model Selection](../../04-models/5-selection-guide.md)
...
- [Plan Agent](../../02-agents/2-built-in-agents.md#plan-agent) - Planning refactorings
- [Testing Guide](../../12-security/2-testing-quality.md) - TDD strategies

### Related Topics

- [Model Selection](../../04-models/5-selection-guide.md) - When to use Opus
...
**Questions?** See the [FAQ](../../11-reference/3-faq.md) or [Troubleshooting Guide](../../11-reference/2-troubleshooting.md)
