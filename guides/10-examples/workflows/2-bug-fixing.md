...
**Prerequisites**: [Agents Overview](../../01-mcp-servers/1-overview.md), [Model Selection](../../04-models/5-selection-guide.md)
...
- [Model Selection Guide](../../04-models/5-selection-guide.md) - Choosing models
...
- [Test-Driven Development](../../10-examples/workflows/7-testing.md#tdd-workflow) - TDD with Claude
