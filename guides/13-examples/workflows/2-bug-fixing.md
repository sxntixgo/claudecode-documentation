...
**Prerequisites**: [Agents Overview](../../01-mcp-servers/1-overview.md), [Model Selection](../../06-models/5-selection-guide.md)
...
- [Agent Overview](../../03-agents/1-overview.md) - Understanding agents
- [Model Selection Guide](../../06-models/5-selection-guide.md) - Choosing models

### Related Topics

- [Explore Agent](../../03-agents/2-built-in-agents.md#explore-agent) - Read-only search
- [Cost Optimization](../../12-optimization/1-cost-optimization.md) - Save on debugging
- [Thinking Modes](../../08-thinking/2-keywords.md) - When to use "think"
- [Test-Driven Development](../../13-examples/workflows/7-testing.md#tdd-workflow) - TDD with Claude
