...
- [Skills Overview](../04-skills/1-overview.md) - Skills leverage agent capabilities
- [Model Selection](../06-models/1-overview.md) - Assign different models to agents
...
- [Cost Optimization](../12-optimization/1-cost-optimization.md) - Speed and cost optimization
- [Advanced Techniques](../12-optimization/2-advanced-techniques.md) - Advanced optimization patterns
