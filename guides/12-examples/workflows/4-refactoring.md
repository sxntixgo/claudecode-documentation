...
**Prerequisites**: [Agents Overview](../../02-agents/1-overview.md), [Plan Agent](../../02-agents/2-built-in-agents.md#plan-agent), [Model Selection](../../05-models/5-selection-guide.md)
...
- [Testing Guide](../../14-security/2-testing-quality.md) - TDD strategies
