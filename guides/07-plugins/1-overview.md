...
- Repeat a complex workflow consistently? → **Skill** ([Section 3](../04-skills/1-overview.md))
- Automate on every file save/commit? → **Hook** ([Section 10](../11-hooks/1-overview.md))
- Quick shortcut for common task? → **Command** ([Section 4](../05-commands/1-overview.md))
...
- [Skills](../04-skills/1-overview.md) - Complex workflows (Plugin Type 2) →
- [Commands](../05-commands/1-overview.md) - Quick shortcuts (Plugin Type 3) →
- [Hooks](../11-hooks/1-overview.md) - Automation (Plugin Type 4) →

**Related Topics**:
- [Model Selection](../06-models/1-overview.md) - Choose models for skills →
- [Context Management](../09-context/1-overview.md) - Organize plugin behavior →
...
- [Skills Development Guide](../04-skills/3-creating-skills.md) - Advanced skill patterns
- [Hooks Configuration](../11-hooks/1-overview.md) - Automation strategies
