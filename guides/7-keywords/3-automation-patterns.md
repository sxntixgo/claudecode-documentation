...
**Prerequisites**: [Slash Commands](2-slash-commands.md), [Custom Skills](../3-skills/3-creating-skills.md)
...
- [Cost Optimization Overview](../8-optimization/1-cost-optimization.md) - Advanced savings strategies
