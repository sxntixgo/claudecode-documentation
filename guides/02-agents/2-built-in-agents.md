...
**→ [Skills Overview](../03-skills/overview.md)** - Learn how skills leverage agent capabilities
...
- [Explore Agent Performance Deep Dive](https://youtube.com/watch?v=example) (10 min) - Why it's 3-5x faster
- [General-Purpose Agent Workflows](https://youtube.com/watch?v=example) (15 min) - Real-world development patterns
- [Plan Agent for Architecture](https://youtube.com/watch?v=example) (20 min) - Complex planning examples
...
- [MCP Servers](../01-mcp-servers/overview.md) - Tools that agents use
- [Skills Overview](../03-skills/overview.md) - Skills that leverage agents
