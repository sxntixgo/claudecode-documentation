...
**Full guide**: See [Creating Custom MCP Servers](../1-mcp-servers/4-creating-custom-servers.md)
...
**Full guide**: See [Creating Custom Agents](../2-agents/4-custom-agents.md)
...
**Full guide**: See [Creating Custom Skills](../3-skills/3-creating-skills.md)
...
**Full guide**: See [Model Selection Guide](../4-models/5-selection-guide.md)
...
**Full guide**: See [Agent Model Assignment](../2-agents/3-model-assignment.md)
...
**Full guide**: See [CLAUDE.md Files](../6-context/2-claude-md.md)
...
**Full guide**: See [Cost Optimization](../8-optimization/1-cost-optimization.md)
...
**Full guide**: See [Optimization Strategies](../8-optimization/2-advanced-techniques.md)
...
**Full guide with calculations**: See [Cost Optimization](../8-optimization/1-cost-optimization.md)
...
**Full guide**: See [Creating Slash Commands](../7-keywords/2-slash-commands.md)
...
**Full guide**: See [Automation Patterns](../7-keywords/3-automation-patterns.md)
