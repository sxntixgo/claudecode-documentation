...
**Prerequisites**: [Model Comparison](../4-models/model-comparison.md)
...
**Learn More**:
- [Full Model Comparison](../4-models/model-comparison.md) - Detailed capabilities
- [Token Optimization](../8-optimization/strategies.md) - Cost strategies
...
**Questions? See [FAQ](../10-reference/3-faq.md#model-selection)**
