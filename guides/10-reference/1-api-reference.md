...
- [Creating Custom Agents](../2-agents/4-custom-agents.md) - Using AGENT.md schema
- [Creating Custom Skills](../3-skills/3-creating-skills.md) - Using SKILL.md schema
- [Creating Slash Commands](../7-keywords/2-slash-commands.md) - Using command schema
- [CLAUDE.md Files](../6-context/2-claude-md.md) - Project context structure
- [Hooks Configuration](../7-keywords/3-automation-patterns.md) - Hook examples
...
- Want examples? Browse [Project Templates](../9-examples/projects/)
