...
**Next Topic**: [Model Selection](../06-models/1-overview.md) - Choose the right model for each task →

**Related Topics**:
- [Skills](../04-skills/1-overview.md) - More complex reusable workflows →
- [Hooks](../11-hooks/1-overview.md) - Automate command execution →
- [Plugins Overview](../07-plugins/1-overview.md) - See how commands fit in the ecosystem →
...
- [Skills](../04-skills/1-overview.md) - Complex workflows with progressive disclosure
- [Hooks](../11-hooks/1-overview.md) - Automation triggers
