...
**Full guide**: See [Model Selection Guide](../04-models/5-selection-guide.md)
...
**Full guide**: See [CLAUDE.md Files](../06-context/2-claude-md.md)
...
**Full guide**: See [Cost Optimization](../09-optimization/1-cost-optimization.md)
...
**Full guide**: See [Optimization Strategies](../09-optimization/2-advanced-techniques.md)
...
**Full guide with calculations**: See [Cost Optimization](../09-optimization/1-cost-optimization.md)
...
**Full guide**: See [Creating Slash Commands](../07-keywords/2-slash-commands.md)
...
**Full guide**: See [Automation Patterns](../07-keywords/3-automation-patterns.md)
