...
- [Creating Slash Commands](../07-keywords/2-slash-commands.md) - Using command schema
- [CLAUDE.md Files](../06-context/2-claude-md.md) - Project context structure
- [Hooks Configuration](../07-keywords/3-automation-patterns.md) - Hook examples
...
- Want examples? Browse [Project Templates](../10-examples/projects/)
