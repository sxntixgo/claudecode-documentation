...
**Scope**: New Plugin Ecosystem Documentation (`guides/13-plugins/1-plugin-ecosystem.md`)
...
- **File**: `guides/13-plugins/1-plugin-ecosystem.md`
- **Lines**: 1480-1482
...
- **Description**: The new `guides/13-plugins/` section is not yet added to the main table of contents
...
- **Files with issues**: 1
- **Issue breakdown**:
  - `guides/13-plugins/1-plugin-ecosystem.md`: 7 important, 5 minor
